<?php include "_header.php";?>
      ...
      <section class="g-bg-secondary">
        <div class="container g-pt-100 g-pb-130">
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-9">
              <div class="js-carousel" data-initial-slide="1" data-infinite="false" data-slides-show="3" data-slides-scroll="1"
    ...
    <section class="g-py-100">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-5 offset-lg-1 g-mb-60 g-mb-0--lg">
            <!-- Icon Blocks -->
        ...
        <div class="container">
          ...
          <div class="row d-flex align-items-lg-center flex-wrap g-mb-60 g-mb-0--lg">
            <div class="col-md-6 col-lg-8">
				<img class="img-fluid rounded" src="./assets/sc/phone1.png" alt="Image Description">
            </div>
                  ...
                  <p class="g-font-size-16">We invited forty girls to order a dress within the new shopping experience and the on-demand model. <br> Learn about the speed, transparency and efficiency in our first case-study.</p>
					<div class="row text-center">
				          <div class="col-lg-3 col-sm-6 g-mb-50">
				            ...
				            <h4 class="h4 g-color-gray-dark-v2">dress</h4>
				          </div>

				          <div class="col-lg-3 col-sm-6 g-mb-50">
				            <div class="js-counter g-color-primary g-font-weight-600 g-font-size-30">10</div>
				            <h4 class="h4 g-color-gray-dark-v2">sizes</h4>
				          </div>

				          <div class="col-lg-3 col-sm-6 g-mb-50">
				            <div class="js-counter g-color-primary g-font-weight-600 g-font-size-30">40</div>
				            <h4 class="h4 g-color-gray-dark-v2">orders</h4>
				          </div>

				          <div class="col-lg-3 col-sm-6 g-mb-50">
				            <div class="js-counter g-color-primary g-font-weight-600 g-font-size-30">3</div>
    ...
    <section class="container">
      <div class="g-bg-secondary g-py-70 g-px-20 g-mb-110">
